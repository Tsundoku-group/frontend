...
const OldTwitterFilled = ({className, ...props}: SVGProps<SVGSVGElement>) => (
    <svg
        ...
        className={className}
        {...props}>
        <path fill="currentColor" fillOpacity="0" stroke="currentColor" strokeDasharray="64" strokeDashoffset="64"
...
export default OldTwitterFilled;